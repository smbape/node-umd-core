(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(["module", "lodash", "backbone"], function () {
            return factory.apply(this, [arguments[0], arguments[1], arguments[2]]);
        });
    } else if (typeof exports === "object" && typeof module !== "undefined") {
        if (typeof process === "object" && typeof process.platform !== "undefined") {
            factory(module, require("lodash"), require("backbone"));
        } else if (global.require && global.require.brunch) {
            factory(module, global._, global.Backbone);
        } else {
            factory(module, require("lodash"), require("backbone"));
        }
    } else {
        ...
        factory(mod, undefined, undefined);
    ...
    return g;
}(this), function (module, _, Backbone) {
    "use strict";
    ...
    /**
     * Modified for usage with lodash.core
     *     - remove _.without
     *     - remove _.intersection
     */

    /* eslint-disable no-use-before-define, consistent-return, no-multi-assign, no-invalid-this, no-useless-escape, no-shadow, no-control-regex, no-prototype-builtins */
    var defaultOptions = {
        forceUpdate: false,
        selector: "name",
    ...
    var flatten = function(obj, into, prefix) {
        ...
        _.each(obj, function (val, key) {
            if (obj.hasOwnProperty(key)) {
                if (Boolean(val) && _.isArray(val)) {
                    _.forEach(val, function (v, k) {
                        flatten(v, into, prefix + key + "." + k + ".");
                        into[prefix + key + "." + k] = v;
                    });
                } else if (Boolean(val) && typeof val === "object" && val.constructor === Object) {
    ...
    var Validation = function () {
        ...
        var getValidators = function(model, attr) {
            ...
            return _.reduce(attrValidationSet, function (memo, attrValidation) {
                for (var validator in attrValidation) {
                    if (validator !== "msg") {
                        memo.push({
        ...
        var validateAttr = function(model, attr, value, computed) {
            ...
            return _.reduce(getValidators(model, attr), function (memo, validator) {
                ...
                var ctx = Object.assign({}, formatFunctions, defaultValidators);
        ...
        var mixin = function(view, options) {
            return {
                ...
                preValidate: function (attr, value) {
                    ...
                    return validateAttr(this, attr, value, Object.assign({}, this.attributes));
                },
                    ...
                    if (attrs) {
                        ...
                        _.each(this.associatedViews, function (view) {
                            _.each(attrs, function (attr) {
                                error = validateAttr(this, attr, flattened[attr], Object.assign({}, this.attributes));
                                if (error) {
                ...
                validate: function(attrs, setOptions) {
                    ...
                    var opt = Object.assign({}, options, setOptions);
                    var validatedAttrs = getValidatedAttrs(model, getOptionsAttrs(options, view));
                    var allAttrs = Object.assign({}, validatedAttrs, model.attributes, attrs);
                    var flattened = flatten(allAttrs);
                    ...
                    if (!opt.forceUpdate) {
                        for (var key in changedAttrs) {
                            if (result.invalidAttrs.hasOwnProperty(key)) {
        ...
        var bindModel = function(view, model, options) {
            ...
            Object.assign(model, mixin(view, options));
        };
        ...
        var unbindModel = function(model, view) {
            if (view && model.associatedViews.length > 1) {
                var index = -1;
                for (var i = 0, len = model.associatedViews.length; i < len; i++) {
                    if (model.associatedViews[i] === view) {
                        index = i;
                    }
                }
                if (index !== -1) {
                    model.associatedViews.splice(index, 1);
                }
            } else {
        ...
        return {
            ...
            bind: function(view, options) {
                options = Object.assign({}, defaultOptions, defaultCallbacks, options);
    ...
    _.each(defaultValidators, function (validator, key) {
        defaultValidators[key] = defaultValidators[key].bind(Object.assign({}, formatFunctions, defaultValidators));
    });
